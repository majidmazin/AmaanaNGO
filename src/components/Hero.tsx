    ...
    <section id="hero" className="relative flex min-h-screen items-center">
      ...
      <div className="relative z-10 mx-auto max-w-7xl px-5 py-32 text-center sm:px-6 lg:px-8">
        ...
        <div className="mt-10 flex flex-col items-center justify-center gap-4 sm:flex-row">
          <Link
            href="/donate"
            className="inline-flex items-center gap-2 rounded-full bg-brand-gold-400 px-8 py-3.5 text-lg font-semibold text-brand-blue-900 shadow-lg transition-all hover:bg-brand-gold-500 hover:shadow-xl"
          >
